...
from dassl.utils import mkdir_if_missing, listdir_nohidden, write_json, read_json
...
class Caltech101(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        self.image_dir = os.path.join(self.dataset_dir, "caltech-101/101_ObjectCategories")
        ...
        if os.path.exists(self.preprocessed_dir):
            ...
            train, val, test = self.read_data(self.image_dir, ignored=IGNORED, new_cnames=NEW_CNAMES)
    ...
    @staticmethod
    def read_data(image_dir, p_trn=0.5, p_val=0.2, ignored=None, new_cnames=None):
