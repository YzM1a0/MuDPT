...
do
  DIR=output/base2new/base/${DATASET}/shots_${SHOTS}/${CFG}_vctx${DEEP_IMG_N_CTX}_tctx${DEEP_TEXT_N_CTX}_vdepth${IMG_PROMPT_DEPTH}_tdepth${TEXT_PROMPT_DEPTH}/seed${SEED}
