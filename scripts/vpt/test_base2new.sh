...
do
  MODEL_DIR=output/base2new/base/${DATASET}/shots_${SHOTS}/${CFG}_nctx${DEEP_IMG_N_CTX}_depth${IMG_PROMPT_DEPTH}/seed${SEED}
  OUTPUT_DIR=output/base2new/new/${DATASET}/shots_${SHOTS}/${CFG}_nctx${DEEP_IMG_N_CTX}_depth${IMG_PROMPT_DEPTH}/seed${SEED}
  if [ -d "$DIR" ]; then
